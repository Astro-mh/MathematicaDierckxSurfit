      subroutine bispevSA(tx,nx,ty,ny,c,kx,ky,x,mx,y,my,yorig,z,wrk,
     * lwrk,iwrk,kwrk,ier)
...
c  ..array arguments..
      integer iwrk(kwrk),yorig(mx)
      real tx(nx),ty(ny),c((nx-kx-1)*(ny-ky-1)),x(mx),y(my),z(mx)
      real wrk(lwrk)
c  ..local scalars..
      integer i,iw,lwest
c  ..
...
c  are invalid control is immediately repassed to the calling program.
      ...
      ier = 0
      iw = mx*(kx+1)+1
      call fpbispSA(tx,nx,ty,ny,c,kx,ky,x,mx,y,my,yorig,z,wrk(1),
